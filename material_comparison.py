...
aluminum_yield_stress = np.array([204, 198, 182, 182, 158, 132, 70, 30, 12]) * 1e6 # Yield stress values (Pa)
...
# Subplot 1: Yield Strength
ax1.plot(inconel_yield_temps, inconel_yield_stress/1e6, 'r', label='Inconel 718')
ax1.plot(aluminum_yield_temps, aluminum_yield_stress/1e6, 'b', label='AlSi10Mg')
ax1.plot(aluminum_6082_yield_temps, aluminum_6082_yield_stress/1e6, 'g', label='Al 6082-T6')
ax1.plot(grcop_yield_temps, grcop_yield_stress/1e6, 'c', label='GRCop-42')
ax1.plot(abd900_yield_temps, abd900_yield_stress/1e6, 'm', label='ABD900')
ax1.set_xlabel('Temperature (deg C)')
ax1.set_ylabel('Yield Strength (MPa)')
ax1.grid()
ax1.legend(loc='upper right')
ax1.set_title('Yield Strength vs Temperature')
ax1.set_ylim(0, 1300)
ax1.set_xlim(0, None)

# Subplot 2: Elastic Modulus
ax2.plot(inconel_modulus_temps, inconel_modulus/1e9, 'r', label='Inconel 718')
ax2.plot(aluminum_modulus_temps, aluminum_modulus/1e9, 'b', label='AlSi10Mg')
ax2.plot(aluminum_6082_modulus_temps, aluminum_6082_modulus/1e9, 'g', label='Al 6082-T6')
ax2.plot(grcop_modulus_temps, grcop_modulus/1e9, 'c', label='GRCop-42')
ax2.plot(abd900_modulus_temps, abd900_modulus/1e9, 'm', label='ABD900')
ax2.set_xlabel('Temperature (deg C)')
ax2.set_ylabel('Elastic Modulus (GPa)')
ax2.grid()
...
# Subplot 3: Yield Strength / Elastic Modulus Ratio
ax3.plot(inconel_temps_common, inconel_ys_e * 1000, 'r', label='Inconel 718')
ax3.plot(aluminum_temps_common, aluminum_ys_e * 1000, 'b', label='AlSi10Mg')
ax3.plot(aluminum_6082_temps_common, aluminum_6082_ys_e * 1000, 'g', label='Al 6082-T6')
ax3.plot(grcop_temps_common, grcop_ys_e * 1000, 'c', label='GRCop-42')
ax3.plot(abd900_temps_common, abd900_ys_e * 1000, 'm', label='ABD900')
ax3.set_xlabel('Temperature (deg C)')
ax3.set_ylabel('Yield Strength / Elastic Modulus (‰)')
ax3.grid()
ax3.legend(loc='upper right')
ax3.set_title('Yield Strength to Elastic Modulus Ratio vs Temperature')
ax3.set_ylim(0, None)
ax3.set_xlim(0, None)
